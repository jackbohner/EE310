...
START:
        ...
        ; ((PORTA) and 0FFh), 0, a = Button A input
        ; ((PORTA) and 0FFh), 1, a = Button B input
...
; active-HIGH:
; ((PORTA) and 0FFh), 0, a = A
; ((PORTA) and 0FFh), 1, a = B
; -------------------------
READ_SWITCHES:
        BANKSEL PORTA
        MOVF PORTA, W
        ANDLW 0x03 ;keep only ((PORTA) and 0FFh), 1, a and ((PORTA) and 0FFh), 0, a
